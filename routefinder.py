"""
NextBus configurator.

Prompts user for transit agency, bus line, direction and stop, issues a string
which can then be copied & pasted into the predictor program.  Not fancy, just
uses text prompts, minimal error checking.
"""
import urllib
...
def getNum(prompt, n):
    while True:
        ...
        if x >= 0 and x < n:
            return x    # and out-of-range values
